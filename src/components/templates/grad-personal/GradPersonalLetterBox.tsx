...
interface GradPersonalLetterBoxProps {
    slug: string;
...
export function GradPersonalLetterBox({ slug, initialLetters, isDark = false, onPopupOpenChange }: GradPersonalLetterBoxProps) {
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-medium shadow-md hover:shadow-xl hover:shadow-emerald-500/30 transition-all hover:scale-105 relative overflow-hidden group"
                >
                    <Plus className="w-4 h-4 relative z-10" />
                    <span className="relative z-10">Write Message</span>
            ...
            {showCreateForm && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className={`${isDark ? "bg-[#1f1e1c] text-slate-100 border border-slate-800" : "bg-white text-gray-900"} rounded-2xl w-full max-w-lg max-h-[90vh] shadow-2xl overflow-hidden flex flex-col border-4 border-emerald-200`}>
                        <div className="bg-gradient-to-r from-emerald-500 to-teal-600 p-4 text-white flex-shrink-0">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <GraduationCap className="w-5 h-5" />
                                    <h3 className="text-lg font-semibold">Write Graduation Message</h3>
                                </div>
                        ...
                        <div className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1">
                            <div>
                                ...
                                <input
                                    ...
                                    maxLength={50}
                                    className={`w-full px-4 py-2 rounded-lg border border-emerald-200 ${isDark ? "bg-[#121110] text-white" : "bg-white text-gray-900"} focus:ring-2 focus:ring-emerald-300 focus:border-emerald-400 outline-none mb-3`}
                                />
                            </div>
                            <div>
                                <label className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-gray-700"} mb-1`}>
                                ...
                                <input
                                    ...
                                    maxLength={50}
                                    className={`w-full px-4 py-2 rounded-lg border border-emerald-200 ${isDark ? "bg-[#121110] text-white" : "bg-white text-gray-900"} focus:ring-2 focus:ring-emerald-300 focus:border-emerald-400 outline-none`}
                                />
                            </div>
                            <div>
                                <label className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-gray-700"} mb-1`}>
                                ...
                                <textarea
                                    ...
                                    maxLength={1000}
                                    rows={6}
                                    className={`w-full px-4 py-2 rounded-lg border border-emerald-200 ${isDark ? "bg-[#121110] text-white" : "bg-white text-gray-900"} focus:ring-2 focus:ring-emerald-300 focus:border-emerald-400 outline-none resize-none`}
                                />
                            </div>
                        ...
                        <div className={`p-4 border-t ${isDark ? "border-slate-800" : "border-emerald-200"} flex justify-end gap-2 flex-shrink-0`}>
                            <button
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:from-emerald-600 hover:to-teal-700 transition-all"
                            >
            ...
            <div className="space-y-4">
                            ...
                            className={`relative group rounded-2xl overflow-hidden transition-all ${
                                locked 
                                    ...
                                    : isDark 
                                        ...
                                        : "bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-emerald-200 shadow-lg hover:shadow-xl"
                            }`}
                        >
                            {locked && (
                                <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                                    <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center mb-3 shadow-lg border-4 border-white">
                            ...
                            <div className={`p-4 sm:p-6 ${locked ? "opacity-30" : ""}`}>
                                <div className="flex items-start justify-between gap-3 mb-3">
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <button
                                            ...
                                            className={`p-1.5 rounded-lg ${isDark ? "hover:bg-slate-800" : "hover:bg-emerald-100"} transition-colors`}
                                        >
                                            {expanded ? (
                                ...
                                {expanded && !locked && (
                                    <div className="space-y-4 mt-4">
                                        ...
                                        {letter.audio_url && (
                                            <div className={`rounded-xl p-4 ${isDark ? "bg-slate-800" : "bg-emerald-100"}`}>
                                        ...
                                        {letter.replies.length > 0 && (
                                            <div className="space-y-3 pt-3">
                                                ...
                                                {letter.replies.map((reply) => (
                                                    ...
                                                    >
                                                        <div className="w-8 h-8 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center flex-shrink-0 border-2 border-white">
                                        ...
                                        {!isReplying ? (
                                            <button
                                                ...
                                                className="w-full py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-medium hover:from-emerald-600 hover:to-teal-700 transition-all"
                                            >
                                            ...
                                            <div className="space-y-2">
                                                <textarea
                                                    ...
                                                    maxLength={300}
                                                    rows={3}
                                                    className={`w-full px-3 py-2 rounded-lg border border-emerald-200 ${isDark ? "bg-[#121110] text-white" : "bg-white text-gray-900"} focus:ring-2 focus:ring-emerald-300 focus:border-emerald-400 outline-none resize-none text-sm`}
                                                />
                                                <div className="flex items-center justify-between">
                                                    <span className={`text-xs ${isDark ? "text-slate-500" : "text-gray-400"}`}>
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-600 text-white text-sm font-medium disabled:opacity-50"
                                                        >
                ...
                {letters.length === 0 && (
                    <div className={`text-center py-12 ${isDark ? "text-slate-400" : "text-gray-400"}`}>
                        ...
                        <p>No messages yet</p>
                        <p className="text-sm mt-1">Be the first to write a graduation message!</p>
                    </div>
                )}
            </div>
