...
import { Image as ImageIcon, Mail, ChevronUp, Settings, Sparkles, Target, Coffee, Sun, Moon, Users, Facebook, Instagram, Calendar } from "lucide-react";
    ...
    return (
        <div className={`min-h-screen relative pb-16 transition-colors duration-500 bg-gradient-to-b ${themeProps.bgClass} overflow-x-hidden`}>
            ...
            <GalleryLightbox
                ...
                onPrev={prevImage}
                onNext={nextImage}
                headerStyle={{ background: `linear-gradient(to right, ${themeProps.accentColor}, ${themeProps.accentColor}dd)` }}
