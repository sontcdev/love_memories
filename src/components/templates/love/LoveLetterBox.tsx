...
export function LoveLetterBox({ slug, initialLetters, isDark = false, onPopupOpenChange }: LoveLetterBoxProps) {
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                >
                    ...
                    <span className="relative z-10">Viết thư</span>
            ...
            {showCreateForm && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className={`${isDark ? "bg-[#1f1e1c] text-slate-100 border border-slate-800" : "bg-amber-50 text-gray-900"} rounded-2xl w-full max-w-lg max-h-[90vh] shadow-2xl overflow-hidden flex flex-col border-2 border-rose-200`}>
                        ...
                        <div className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1" style={{
                            backgroundImage: isDark ? 'none' : 'repeating-linear-gradient(transparent, transparent 31px, #e5e7eb 31px, #e5e7eb 32px)',
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    maxLength={50}
                                    className={`w-full px-4 py-2 rounded-lg border border-rose-200 ${isDark ? "bg-[#121110] text-white" : "bg-white/80 text-gray-900"} focus:ring-2 focus:ring-rose-300 focus:border-rose-400 outline-none mb-3`}
                                />
                            </div>
                            <div>
                                <label className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-gray-700"} mb-1`}>
                                ...
                                <input
                                    ...
                                    maxLength={50}
                                    className={`w-full px-4 py-2 rounded-lg border border-rose-200 ${isDark ? "bg-[#121110] text-white" : "bg-white/80 text-gray-900"} focus:ring-2 focus:ring-rose-300 focus:border-rose-400 outline-none`}
                                />
                            </div>
                            <div>
                                <label className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-gray-700"} mb-1`}>
                                ...
                                <textarea
                                    ...
                                    maxLength={1000}
                                    rows={6}
                                    className={`w-full px-4 py-2 rounded-lg border border-rose-200 ${isDark ? "bg-[#121110] text-white" : "bg-white/80 text-gray-900"} focus:ring-2 focus:ring-rose-300 focus:border-rose-400 outline-none resize-none`}
                                />
                            </div>
                            <VideoInput value={newVideoUrl} onChange={setNewVideoUrl} />
                            <VoiceRecorder slug={slug} onUploadComplete={setNewAudioUrl} />
                            <div>
                                <label className={`block text-sm font-medium ${isDark ? "text-slate-300" : "text-gray-700"} mb-1 flex items-center gap-2`}>
                        ...
                        <div className={`p-4 border-t ${isDark ? "border-slate-800" : "border-rose-200"} flex justify-end gap-2 flex-shrink-0`}>
                            <button
                                onClick={() => setShowCreateForm(false)}
                                className={`px-4 py-2 rounded-lg ${isDark ? "bg-slate-800 text-slate-300 hover:bg-slate-700" : "bg-gray-100 text-gray-700 hover:bg-gray-200"} transition-colors`}
                            >
                                Hủy
                            </button>
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-rose-400 to-pink-500 text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:from-rose-500 hover:to-pink-600 transition-all"
                            >
            ...
            <div className="space-y-4">
                            ...
                            <div className={`relative rounded-2xl overflow-hidden transition-all duration-300 ${
                                locked 
                                    ...
                                    : isDark 
                                        ...
                                        : "bg-gradient-to-br from-amber-50 to-rose-50 border-2 border-rose-200 shadow-lg hover:shadow-xl hover:scale-[1.01]"
                            }`}>
                                {locked && (
                                    <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                                        <div className="relative">
                                            <div className="absolute inset-0 bg-rose-400 rounded-full blur-xl opacity-30 animate-pulse"></div>
                                            <div className="relative w-16 h-16 bg-gradient-to-br from-rose-300 to-pink-400 rounded-full flex items-center justify-center mb-3 shadow-lg">
                                                <Lock className="w-8 h-8 text-white" />
                                            </div>
                                        </div>
                                        <p className={`text-sm font-medium ${isDark ? "text-slate-400" : "text-gray-600"} mt-2`}>
                                            Thư sẽ mở vào ngày {formatUnlockDate(letter.unlock_date!)}
                                        </p>
                                    </div>
                                )}
                                ...
                                <div className={`p-4 sm:p-6 ${locked ? "opacity-30" : ""}`}>
                                    <div className="flex items-start justify-between gap-3 mb-3">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-1">
                                                <div className="relative">
                                                    <div className="absolute inset-0 bg-rose-400 rounded-full blur-md opacity-40"></div>
                                                    <Heart className="relative w-4 h-4 text-rose-500 fill-current" />
                                                </div>
                                                <h3 className={`font-bold text-lg ${isDark ? "text-slate-100" : "text-gray-800"}`}>
                                                    {letter.title}
                                                </h3>
                                            </div>
                                            {letter.sender && (
                                                <p className={`text-sm ${isDark ? "text-slate-400" : "text-gray-500"} italic`}>
                                                    Từ: {letter.sender}
                                                </p>
                                            )}
                                        </div>
                                        <div className="flex items-center gap-1">
                                            ...
                                            <button
                                                ...
                                                className={`p-1.5 rounded-lg ${isDark ? "hover:bg-slate-800" : "hover:bg-rose-100"} transition-colors`}
                                            >
                                                {expanded ? (
                                    ...
                                    {expanded && !locked && (
                                        <div className="space-y-4 mt-4">
                                            <div className={`prose prose-sm max-w-none ${isDark ? "text-slate-200" : "text-gray-700"} whitespace-pre-wrap leading-relaxed`}>
                                                {letter.content}
                                            </div>
                                            ...
                                            {letter.audio_url && (
                                                <div className={`rounded-xl p-4 ${isDark ? "bg-slate-800" : "bg-rose-100"}`}>
                                            ...
                                            {letter.replies.length > 0 && (
                                                <div className="space-y-3 pt-3">
                                                    <h4 className={`text-sm font-semibold ${isDark ? "text-slate-300" : "text-gray-700"}`}>
                                                        Phản hồi ({letter.replies.length})
                                                    </h4>
                                                    {letter.replies.map((reply) => (
                                                        <div
                                                            key={reply.id}
                                                            className={`flex gap-3 ${isDark ? "bg-slate-800" : "bg-white/80"} rounded-xl p-3`}
                                                        >
                                                            <div className="w-8 h-8 bg-gradient-to-br from-rose-400 to-pink-500 rounded-full flex items-center justify-center flex-shrink-0">
                                                                <Heart className="w-4 h-4 text-white fill-current" />
                                                            </div>
                                                            <div className="flex-1">
                                                                <p className={`text-sm ${isDark ? "text-slate-200" : "text-gray-700"}`}>{reply.content}</p>
                                            ...
                                            {!isReplying ? (
                                                <button
                                                    ...
                                                    className="w-full py-2 rounded-lg bg-gradient-to-r from-rose-400 to-pink-500 text-white font-medium hover:from-rose-500 hover:to-pink-600 transition-all"
                                                >
                                                ...
                                                <div className="space-y-2">
                                                    <textarea
                                                        ...
                                                        maxLength={300}
                                                        rows={3}
                                                        className={`w-full px-3 py-2 rounded-lg border border-rose-200 ${isDark ? "bg-[#121110] text-white" : "bg-white text-gray-900"} focus:ring-2 focus:ring-rose-300 focus:border-rose-400 outline-none resize-none text-sm`}
                                                    />
                                                    <div className="flex items-center justify-between">
                                                        <span className={`text-xs ${isDark ? "text-slate-500" : "text-gray-400"}`}>
                                                        ...
                                                        <div className="flex gap-2">
                                                            <button
                                                                ...
                                                                className={`px-3 py-1.5 rounded-lg ${isDark ? "bg-slate-800 text-slate-300" : "bg-gray-100 text-gray-700"} text-sm`}
                                                            >
                                                                Hủy
                                                            </button>
                                                            <button
                                                                ...
                                                                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-rose-400 to-pink-500 text-white text-sm font-medium disabled:opacity-50"
                                                            >
                ...
                {letters.length === 0 && (
                    <div className={`text-center py-12 ${isDark ? "text-slate-400" : "text-gray-400"}`}>
                        ...
                        <p>Chưa có thư tình nào</p>
                        <p className="text-sm mt-1">Hãy là người đầu tiên viết thư!</p>
                    </div>
                )}
            </div>
            ...
            <ConfirmDialog
                ...
                title="Xác nhận xóa"
                message={deleteConfirm?.type === "letter" ? "Bạn có chắc muốn xóa bức thư này?" : "Bạn có chắc muốn xóa phản hồi này?"}
                confirmText="Xóa"
                cancelText="Hủy"
                onConfirm={() => {
