        ...
        <div className="space-y-4">
            {!showForm ? (
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-sky-400 to-emerald-400 text-white font-medium hover:from-sky-500 hover:to-emerald-500 transition-all shadow-lg hover:shadow-xl hover:shadow-sky-400/30 relative overflow-hidden group"
                >
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-xl border border-sky-100 p-4 shadow-sm">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 py-2 rounded-lg bg-gradient-to-r from-sky-400 to-emerald-400 text-white font-medium hover:from-sky-500 hover:to-emerald-500 transition-all disabled:opacity-50"
                        >
                            {isSubmitting ? (
