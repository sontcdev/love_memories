...
const defaultQuiz: QuizQuestion[] = [
    { question: "Trong nhà mình, ai là người hay ngủ nướng nhất vào cuối tuần?" },
    { question: "Ai là người nấu ăn ngon nhất trong gia đình?" },
    { question: "Ai là 'chuyên gia' hay quên đồ nhất nhà?" },
    { question: "Ai là người hay lo lắng, nhắc nhở cả nhà nhiều nhất?" },
    { question: "Khi cả nhà đi chơi xa, ai là người chuẩn bị đồ đạc kỹ nhất?" }
];
...
export function GameSection({
    ...
    const activeOptions = members.length > 0 ? members : [
        ...
        { id: "m4", name: "Cả nhà đều xứng đáng" }
    ];
            ...
            {gameState === "start" && (
                <div className="text-center space-y-6 py-6">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-xl sm:text-2xl font-serif font-bold">Thử Thách Bình Chọn Gia Đình</h3>
                        <p className={`text-xs sm:text-sm max-w-md mx-auto leading-relaxed ${isDark ? "text-slate-400" : "text-gray-500"}`}>
                            Hãy cùng tham gia cuộc bình chọn vui xem ai trong {familyName} phù hợp nhất với các danh hiệu đáng yêu. Kết quả thống kê tỉ lệ bình chọn sẽ hiển thị ngay sau khi bạn vote!
                        </p>
                    </div>
                    <button
            ...
            {gameState === "ended" && (
                <div className="space-y-6 py-4">
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="mt-3 text-lg font-serif font-bold">Thống kê bình chọn cả nhà</h3>
