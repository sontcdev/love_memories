...
import { Heart, Calendar, Image as ImageIcon, Mail, ChevronUp, Settings, Sparkles, Sun, Moon } from "lucide-react";
    ...
    return (
        <div className={`min-h-screen relative pb-20 font-sans selection:bg-rose-200 transition-colors duration-500 ${isDark ? "dark bg-[#1a1816] text-slate-100" : "bg-[#faf6f0] text-gray-800"}`}>
            ...
            <GalleryLightbox
                ...
                cardClass={isDark ? "bg-[#282420] text-slate-100" : "bg-white text-gray-800"}
                navClass={isDark ? "bg-rose-950/30 text-rose-400 hover:bg-rose-950/50" : "bg-rose-50 text-rose-500 hover:bg-rose-100"}
                borderClass={isDark ? "border-rose-900/30" : "border-gray-100"}
